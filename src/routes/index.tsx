...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "The Saree Edit — Handloom Sarees" },
      {
        name: "description",
        content:
          "A boutique edit of handloom sarees in earthy terracotta and sage — festive days, weddings and everyday elegance.",
      },
      { property: "og:title", content: "The Saree Edit — Grace in every drape" },
      {
        property: "og:description",
        content: "Handpicked sarees for festive days and quiet everyday moments.",
      },
    ],
  }),
  component: Index,
        ...
        <div className="order-2 flex items-center bg-secondary/60 px-6 py-16 md:order-1 md:px-14 lg:px-20">
          ...
          >
            ...
            <p className="max-w-md text-base leading-relaxed text-muted-foreground">
              An earthy, considered edit of handloom sarees — clay-warm colour, sage calm and
              pieces meant to be worn again and again.
            </p>
